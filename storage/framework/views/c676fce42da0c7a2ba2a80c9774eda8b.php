...
<body class="bg-gradient-primary">
    <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
        <div class="container">
            <a class="navbar-brand text-primary" style="font-weight: 900;" href="<?php echo e(url('/')); ?>"> SPK SDN 73 Bengkulu</a>
        </div>
    </nav>
...
<?php /**PATH C:\Users\wahyu\Desktop\SPK-Profile-Matching\resources\views/login.blade.php ENDPATH**/ ?>