...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="d-sm-flex align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-danger"><i class="fa fa-table"></i> <?php echo e($key->keterangan); ?> (<?php echo e($key->kode_kriteria); ?>)</h6>
...
<?php /**PATH C:\xampp\htdocs\AYO-PUBLISH\LARAVEL-10\SPK-SAW-LARAVEL-10\resources\views/sub_kriteria/index.blade.php ENDPATH**/ ?>