...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw fa-plus"></i> Tambah Data Aspek</h6>
    </div>

    <form action="<?php echo e(url('Aspek/simpan')); ?>" method="POST">
...
<?php /**PATH C:\xampp\htdocs\AYO-PUBLISH\LARAVEL-10\SPK-PM-LARAVEL-10\resources\views/aspek/tambah.blade.php ENDPATH**/ ?>