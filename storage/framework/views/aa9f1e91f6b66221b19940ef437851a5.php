		...
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<input autocomplete="off" type="email" name="email" value="<?php echo e($profile->email); ?>" required class="form-control">
				</div>
...
<?php /**PATH C:\xampp\htdocs\AYO-PUBLISH\LARAVEL-10\SPK-SAW-LARAVEL-10\resources\views/profile/index.blade.php ENDPATH**/ ?>