...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?php echo e($page == 'Sub Kriteria' ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('SubKriteria')); ?>">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                                    ...
                                    <img src="<?php echo e(asset('img/user.png')); ?>" class="img-profile rounded-circle">
                                </a>
                    ...
                    <div class="container-fluid"><?php /**PATH C:\xampp\htdocs\AYO-PUBLISH\LARAVEL-10\SPK-SAW-LARAVEL-10\resources\views/layouts/header_admin.blade.php ENDPATH**/ ?>