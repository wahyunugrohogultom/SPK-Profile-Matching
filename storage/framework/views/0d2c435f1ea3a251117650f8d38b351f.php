...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="d-sm-flex align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-table"></i> <?php echo e($key->keterangan); ?> (<?php echo e($key->kode_aspek); ?>)</h6>
            
            <a href="#tambah<?php echo e($key->id_aspek); ?>" data-toggle="modal" class="btn btn-sm btn-success"> <i class="fa fa-plus"></i> Tambah Data </a>
        </div>
    </div>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a data-toggle="modal" title="Edit Data" href="#editsk<?php echo e($key->id_kriteria); ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                                <a data-toggle="tooltip" data-placement="bottom" title="Hapus Data" href="<?php echo e(url('Kriteria/destroy/'.$key->id_kriteria)); ?>" onclick="return confirm('Apakah anda yakin untuk menghapus data ini')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                            </div>
                        </td>
                    </tr>
...
<?php /**PATH C:\xampp\htdocs\AYO-PUBLISH\LARAVEL-10\SPK-PM-LARAVEL-10\resources\views/kriteria/index.blade.php ENDPATH**/ ?>