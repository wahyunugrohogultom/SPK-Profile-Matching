...
class PenilaianController extends Controller
{
    ...
    public function tambah(Request $request)
    {
        ...
        foreach ($nilai as $key) {
            PenilaianModel::tambah_penilaian($id_alternatif, $id_aspek[$i], $id_kriteria[$i], $key);
            $i++;
        }
    ...
    public function edit(Request $request)
    {
        ...
        foreach ($nilai as $key) {
            $cek = PenilaianModel::data_penilaian($id_alternatif, $id_aspek[$i], $id_kriteria[$i]);
            if (!$cek) {
                PenilaianModel::tambah_penilaian($id_alternatif, $id_aspek[$i], $id_kriteria[$i], $key);
            } else {
                PenilaianModel::edit_penilaian($id_alternatif, $id_aspek[$i], $id_kriteria[$i], $key);
            }
            $i++;
        }
